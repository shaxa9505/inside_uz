...
(function ($) {
  ...
  $container.append(
    '<h5>Настроить AdminLTE</h5><hr class="mb-2"/>'
  )
  ...
  var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>Темный режим</span>')
  $container.append($dark_mode_container)

  $container.append('<h6>Параметры заголовка</h6>')
  ...
  $container.append('<h6>Параметры боковой панели</h6>')
  ...
  $container.append('<h6>Параметры нижнего колонтитула</h6>')
  ...
  $container.append('<h6>Параметры мелкого текста</h6>')
  ...
  // var $navbar_variants_colors = createSkinBlock(navbar_all_colors ? navbar_all_colors : null, function () {
  //   var color = $(this).data('color')
  //   var $main_header = $('.main-header')
  //   $main_header.removeClass('navbar-dark').removeClass('navbar-light')
  //   navbar_all_colors ? navbar_all_colors.forEach(function (color) {
